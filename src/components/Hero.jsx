    ...
    <>
      <style>{`
        @keyframes text-glow {
          ...
          100% { 
            filter: brightness(1.1) drop-shadow(0 0 15px rgba(255, 140, 66, 0.6));
          }
        }
        ...
        @keyframes status-blink {
          0%, 50% { 
            opacity: 1;
            text-shadow: 0 0 8px rgba(212, 165, 199, 0.5);
          }
          51%, 100% { 
            opacity: 0.7;
            text-shadow: 0 0 4px rgba(212, 165, 199, 0.3);
          }
        }
      `}</style>
      <section id="hero" className="relative w-full h-screen mx-auto">
        {/* Player Name and Stats - Top Right */}
        <div
        ...
        >
          <motion.h1
            ...
            style={{
              ...
              color: "#fee1c7",
              marginBottom: "16px",
              textShadow: "0 0 10px rgba(254, 225, 199, 0.4)",
            }}
          >
            [ PLAYER:{" "}
            <span
          ...
          <motion.div
            ...
            style={{
              ...
              borderRadius: "12px",
              padding: "16px",
              boxShadow: "6px 6px 0 #4a9b8e, 0 0 25px rgba(74, 155, 142, 0.3)",
          ...
          >
            <div
              style={{
                ...
                fontWeight: "bold",
                marginBottom: "12px",
                textShadow: "0 0 8px rgba(254, 225, 199, 0.5)",
              }}
            >
              [ CLASS: FULL_STACK_DEVELOPER ]
            </div>
            ...
            >
              ...
              >
                ...
                >
                  3D_VISUALS, UI_INTERFACES, WEB_APPS
                </span>
              </div>
              ...
              >
                ...
                <span
                  style={{
                    ...
                    fontSize: "12px",
                    fontWeight: "bold",
                    textShadow: "0 0 8px rgba(74, 155, 142, 0.5)",
                  }}
                >
                  [ EXPERT ]
                </span>
        ...
        <div
          style={{
            ...
            width: "300px",
            padding: "28px",
            background: `radial-gradient(120% 160% at 50% 0%, rgba(255,140,66,0.12), rgba(0,0,0,0) 60%),
              ...
              return (
                <button
                  ...
                  onMouseDown={(e) => {
                    ...
                    e.currentTarget.style.boxShadow = "3px 3px 0 #4a9b8e"
                  }}
                  onMouseUp={(e) => {
        ...
        {/* Start Adventure Button - Bottom Left */}
          ...
          >
            <button
              ...
              style={{
                ...
                fontFamily: '"Roboto Mono", "Courier New", monospace',
                textShadow: "0 0 10px rgba(74, 155, 142, 0.5)",
              }}
              onMouseDown={(e) => {
                e.currentTarget.style.transform = "translate(3px, 3px)"
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.textShadow =
                  "0 0 15px rgba(255, 140, 66, 0.7)"
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.color = "#4a9b8e"
                e.currentTarget.style.boxShadow = "6px 6px 0 #ff8c42"
                e.currentTarget.style.textShadow =
                  "0 0 10px rgba(74, 155, 142, 0.5)"
              }}
            >
              <span>[ START_ADVENTURE ]</span>
              <svg
                width="20"
                height="20"
                viewBox="0 0 24 24"
